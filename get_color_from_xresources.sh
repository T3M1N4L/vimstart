...
convert -size 32x32 -background "$colorbg" -fill "$colorbg" -pointsize 10 -fill "$colorfg" -font "DejaVu-Sans-Bold" -gravity Center caption:"~/" -flatten $(dirname $0)/favicon.ico
